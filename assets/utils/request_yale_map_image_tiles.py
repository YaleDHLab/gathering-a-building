...
def request_image_tiles(image_id):
  ...
  query_root = "http://brbl-zoom.library.yale.edu/fcgi-bin/iipsrv.fcgi?FIF=SML_MAPS_TRANSFER/2/"
  ...
  for i in xrange(1000):
    try:
      query = 'wget "' + query_root + str(zoom_depth) + ',' + str(i) 
      query += '" -O ' + out_dir + "/" + str(i) + ".jp2"
